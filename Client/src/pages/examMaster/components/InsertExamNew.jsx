...
export default function InsertExams() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (input.ExamName === "" || input.ExamHeading === "")
      return toast.warn("Please add exam name and heading");
    if (input.ALTMTHour === "" || input.ALTMTMin === "")
      return toast.warn("Please add time");
    if (input.ExamDateStr === "" || input.year === "")
      return toast.warn("Please add Date & Year");
    if (input.className.id === "" || input.subject.id === "")
      return toast.warn("Please select Class and Subject");
    ...
    <>
      {
        <form onSubmit={handleSubmit} className="flex flex-col px-3 py-1">
          <div className="flex flex-col space-y-2 w-full">
            <div className="flex items-center space-x-2 justify-between">
              ...
              <Input
                ...
                onChange={(e) =>
                  setInput({ ...input, ExamDateStr: e.target.value })
                }
                className="w-64"
                id="date"
              ></Input>
            ...
            <div className="flex items-center space-x-2 justify-between">
              ...
              <Input
                ...
                onChange={(e) =>
                  setInput({ ...input, ExamName: e.target.value })
                }
              ></Input>
            </div>
            <div className="flex items-center space-x-2 justify-between">
              ...
              <Input
                ...
                onChange={(e) =>
                  setInput({ ...input, ExamHeading: e.target.value })
                }
              ></Input>
            </div>
            <div className="flex items-center space-x-2 justify-between">
              ...
              <Input
                ...
                onChange={(e) =>
                  setInput({ ...input, ExamSubHeading: e.target.value })
                }
                id="examname"
              ></Input>
            </div>
            <div className="flex items-center space-x-2 justify-between">
              ...
              <Select
                defaultValue={input.className.name}
                onValueChange={(v) => handleSelect(v, "class")}
              >
                <SelectTrigger id="class" className="w-64">
                  <SelectValue
                    placeholder={loading ? "Loading..." : "Choose Class"}
                  />
                </SelectTrigger>
                <SelectContent>
                  {classList.length > 0 &&
            ...
            <div className="flex items-center space-x-2 justify-between">
              ...
              <Select
                defaultValue={input.subject.name}
                onValueChange={(v) => handleSelect(v, "sub")}
              >
                <SelectTrigger id="class" className="w-64">
                  <SelectValue
                    placeholder={loading ? "Loading..." : "Choose Subject"}
                  />
                </SelectTrigger>
                <SelectContent>
            ...
            <div className="flex items-center space-x-2 justify-between">
              ...
              <div className="flex">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setInput({ ...input, ALTMTHour: e.target.value })
                  }
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setInput({ ...input, ALTMTMin: e.target.value })
                  }
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setInput({ ...input, ALTMTSec: e.target.value })
                  }
          ...
          <div className="flex justify-end mt-2">
            <button
              type="submit"
              className="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 w-fit disabled:pointer-events-none disabled:opacity-50 bg-primary text-primary-foreground hover:bg-primary/90 h-10 px-4 py-2"
            >
