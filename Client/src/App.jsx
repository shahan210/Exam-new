            ...
            <GlobalProvider>
                <BrowserRouter>
                    <Routes>
                        ...
                        <Route path="/user_master/create-user" element={<UserMasterEdit />} />
                        {/* unais routes */}
                        <Route path="/exam_master" element={<ExamMaster />} />
                        <Route path="/exam_master/add-new-ques" element={<AddNewQuestionMaster />} />
                        <Route path="/exam_master/edit-exam-info" element={<EditExamDetails />} />
                        <Route path="/exam_master/edit-quiz-info" element={<EditQuestionMaster />} />
                        {/* unais routes */}
                    </Routes>
                </BrowserRouter>
            </GlobalProvider>
