...
export const createExamMaster = async (req, res) => {
  try {
    const result = await pool.query(
      "INSERT INTO examdefinitiontmst (AcaYear, ExamDate , ExamName, ClassId,  SubjectID, AddedBy, AddedDate,ALTMHour,ALTMTMin,ALTMTSec,ExamHeading ,ExamSubHeading) VALUES (?,?,?,?,?,?,?,?,?,?,?,?);",
      [
        autoID,
        QstClass,
        newData.CLNAME,
